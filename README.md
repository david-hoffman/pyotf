...
![Comparison of HanserPSF and SheppardPSF Outputs](https://github.com/david-hoffman/pyOTF/blob/packaging/fixtures/otf.png?raw=true "Output of python -m py_otf.otf")
...
![First 15 zernike Polynomials plotted on the unit disk](https://github.com/david-hoffman/pyOTF/blob/packaging/fixtures/zernike.png?raw=true "Output of python -m py_otf.zernike")
